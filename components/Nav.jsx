...
export default function Nav() {
  return (
    <div className="absolute top-0 left-0 w-full h-40 lg:h-20 py-3 bg-transparent border-b-[.25px] border-black flex flex-col md:flex-row justify-between items-start px-1 lg:px-20">
